...
const concatstrings = function (casa, giardino) {
  const parola1 = casa.slice(0, 2).toUpperCase();
  const parola2 = giardino.slice(-3).toUpperCase();
  const parole = parola1 + parola2;

  console.log(parole);
};

concatstrings("casa", "giardino");
...
console.log(incrementaArray(array, n));
...
const colori = ["purple", "is", "purple"];

const numeristringhe = colori.map((stringa) => {
